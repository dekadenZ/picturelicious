...
<h1>
  &raquo; Browsing
  <?php if (!is_null($ib->user)) { ?>
    User: <a href="<?php echo Config::$absolutePath, $ib->basePath; ?>"><?php echo $ib->user->name; ?></a>
...
<div class="userInfo">
  ...
  <div class="name">
    <strong>
      <a href="<?php echo Config::$absolutePath, $ib->basePath; ?>"><?php echo $ib->user->name; ?></a>
    </strong>
  </div>
  <div class="info">
